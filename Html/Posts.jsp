...
rs=st.executeQuery("select ProjectTitle,GroupName,CapitalAmount,SocialImpact,Competitors,ProjectType,CompetitiveAdvCount,MAX(ViewCount) from Project");
while(rs.next()){
...
<!----------------------------------------->	
	...
	<div class="rightPost"> 
		...
		int n=1;
		String strclass="";
		rs1=st.executeQuery("select ProjectTitle,GroupName,CapitalAmount,SocialImpact,Competitors,ProjectType,CompetitiveAdvCount,ViewCount from Project");
		while(rs1.next()){
